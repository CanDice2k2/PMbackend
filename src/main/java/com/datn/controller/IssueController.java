...
import com.datn.service.IssueService;
...
//    }
    ...
    @PutMapping("/{issueId}/unassign/{userId}")
    public ResponseEntity<Issue> removeUserFromIssue(
            @PathVariable Long issueId,
            @PathVariable Long userId) throws UserException, IssueException, ProjectException {

        // Verify the user making the request
//        User user = userService.findUserProfileByJwt(token);

        // Remove the assignee from the issue
        Issue updatedIssue = issueService.removeUserFromIssue(issueId, userId);
    ...
    public ResponseEntity<Issue>updateIssueStatus(
            ...
            @PathVariable Long issueId) throws IssueException, ProjectException {
